...
<div id="apps-root">
    ...
    <q-layout view="hHh LpR fFf">
                    ...
                    <div v-else-if="navMenuItem.subscreens && navMenuItem.subscreens.length" class="cursor-pointer">
                        ...
                        <q-menu anchor="bottom left" self="top left">
                            <q-list dense style="min-width: 200px">
                                <q-item v-for="subscreen in navMenuItem.subscreens" :key="subscreen.name" :class="{'bg-primary':subscreen.active, 'text-white':subscreen.active}" clickable v-close-popup>
                                    <q-item-section>
        ...
        <q-page-container class="q-ma-sm"><q-page>
            <m-subscreens-active id="test"></m-subscreens-active>
